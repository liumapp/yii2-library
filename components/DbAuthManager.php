...
use liumapp\library\auth\Item;
use liumapp\library\auth\Permission;
use liumapp\library\auth\Role;
use liumapp\library\auth\Rule;
use yii\rbac\Assignment;

class DbAuthManager extends BaseManager
{
    ...
    public function checkAccess($userId, $permissionName, $params = [])
    {
        ...
        if (isset($app->params['superAdminId']) &&
            $app->params['superAdminId'] == $userId
        ) {
            return true;
        }
        if ($permissionName == 'admin') {

            $permissionName = $app->controller->getRoute();
        }
